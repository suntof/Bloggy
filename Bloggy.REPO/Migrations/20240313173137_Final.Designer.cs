...
namespace Bloggy.REPO.Migrations
{
    ...
    [Migration("20240313173137_Final")]
    partial class Final
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bloggy.CORE.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "1ae7375e-9ea0-4547-8876-1a674745d333",
                            Name = "SuperAdmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "bb30feb2-6248-4bf8-b80e-f0e3d2a2f440",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "7171d7ec-cd3c-471f-b4ee-4ee545f81d6a",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Bloggy.CORE.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9ee5c311-8960-46e9-8271-3c294dfe3f4d",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGzg1QkRx/oSK9UQDfdV7ZdRF+pcvk8iH8X1OhMPgPC3NBbyK3qebb1aaIlfSaRv/A==",
                            PhoneNumber = "+905067600769",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "c8e6058c-3fc0-4427-9722-375fe04dda4e",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "083ae5d9-b4a4-484a-b0e1-3f55899a7b04",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEL4IRDhWCBvHaik73Dpr16c7k/8PdC841UpxAwHwEyLc03kqE+ILm02WIp6r9/JxZA==",
                            PhoneNumber = "+905069999999",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "81c27855-912f-4750-adca-795a59c22e8b",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Bloggy.CORE.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 3, 13, 20, 31, 36, 487, DateTimeKind.Local).AddTicks(1794),
            ...
            modelBuilder.Entity("Bloggy.CORE.Entities.ArticleVisitor", b =>
                {
            ...
            modelBuilder.Entity("Bloggy.CORE.Entities.Genre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("15fd39a8-a3fc-46a1-b40b-5ae6825b4c5a"),
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 3, 13, 20, 31, 36, 487, DateTimeKind.Local).AddTicks(4107),
                            IsDeleted = false,
                            Name = "ASP.Net Core"
                        });
                });
            ...
            modelBuilder.Entity("Bloggy.CORE.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 3, 13, 20, 31, 36, 487, DateTimeKind.Local).AddTicks(4286),
            ...
            modelBuilder.Entity("Bloggy.CORE.Entities.Visitor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bloggy.CORE.Entities.ArticleVisitor", b =>
                {
                    b.HasOne("Bloggy.CORE.Entities.Article", "Article")
                        .WithMany("ArticleVisitors")
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Bloggy.CORE.Entities.Visitor", "Visitor")
                        .WithMany("ArticleVisitors")
